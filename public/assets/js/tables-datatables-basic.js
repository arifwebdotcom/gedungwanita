...
document.addEventListener("DOMContentLoaded", function(e) {
    ...
    var s, t = document.querySelector(".datatables-basic");
    let l;
    t && ((r = document.createElement("h5")).classList.add("card-title", "mb-0"),
    r.innerHTML = "DataTable with Buttons",
    l = new DataTable(t,{
        ...
        columnDefs: [{
            ...
            render: function(e, t, a, r) {
                ...
                let l;
                if (n)
                    l = `<img src="${assetsPath}img/avatars/${n}" alt="Avatar" class="rounded-circle">`;
                else {
                    n = ["success", "danger", "warning", "info", "dark", "primary", "secondary"][Math.floor(6 * Math.random())];
                    let e = s.match(/\b\w/g) || [];
                    e = ((e.shift() || "") + (e.pop() || "")).toUpperCase(),
                    l = `<span class="avatar-initial rounded-circle bg-label-${n}">${e}</span>`
                }
                return `
              <div class="d-flex justify-content-start align-items-center user-name">
                ...
                <div class="d-flex flex-column">
                  <span class="emp_name text-truncate h6 mb-0">${s}</span>
            ...
            render: function(e, t, a, r) {
                ...
                return void 0 === n[a] ? e : `
              <span class="badge rounded-pill  ${n[a].class}">
                ${n[a].title}
              </span>
            `
            }
            ...
            render: function(e, t, a, r) {
                return '<div class="d-inline-block"><a href="javascript:;" class="btn btn-sm btn-text-secondary rounded-pill btn-icon dropdown-toggle hide-arrow" data-bs-toggle="dropdown"><i class="icon-base ri ri-more-2-line icon-22px"></i></a><ul class="dropdown-menu dropdown-menu-end m-0"><li><a href="javascript:;" class="dropdown-item">Details</a></li><li><a href="javascript:;" class="dropdown-item">Archive</a></li><div class="dropdown-divider"></div><li><a href="javascript:;" class="dropdown-item text-danger delete-record">Delete</a></li></ul></div><a href="javascript:;" class="btn btn-sm btn-text-secondary rounded-pill btn-icon item-edit"><i class="icon-base ri ri-edit-box-line icon-22px"></i></a>'
            }
        }],
        select: {
            style: "multi",
                            ...
                            exportOptions: {
                                ...
                                format: {
                                    body: function(e, t, a) {
                                        ...
                                        ) : r = e.body.textContent || e.body.innerText,
                                        r.trim()
                                    }
                                }
                            }
        ...
        responsive: {
            details: {
                ...
                renderer: function(e, t, a) {
                    var r, n, s, a = a.map(function(e) {
                        return "" !== e.title ? `<tr data-dt-row="${e.rowIndex}" data-dt-column="${e.columnIndex}">
                      <td>${e.title}:</td>
                      <td>${e.data}</td>
                    </tr>` : ""
                    }).join("");
                    return !!a && ((r = document.createElement("div")).classList.add("table-responsive"),
    ...
    fv.on("core.form.valid", function() {
        var e = document.querySelector(".add-new-record .dt-full-name").value
          ...
          , r = document.querySelector(".add-new-record .dt-date").value
    ...
    var r = document.querySelector(".dt-row-grouping");
    let n;
    r && (n = new DataTable(r,{
        ajax: assetsPath + "json/table-datatable.json",
        columns: [{
        ...
        columnDefs: [{
            ...
            className: "d-flex align-items-center",
            render: function(e, t, a, r) {
                return '<div class="d-inline-block"><a href="javascript:;" class="btn btn-sm btn-text-secondary rounded-pill btn-icon dropdown-toggle hide-arrow" data-bs-toggle="dropdown"><i class="ri ri-more-2-fill icon-22px"></i></a><div class="dropdown-menu dropdown-menu-end m-0"><a href="javascript:;" class="dropdown-item">Details</a><a href="javascript:;" class="dropdown-item">Archive</a><div class="dropdown-divider"></div><a href="javascript:;" class="dropdown-item text-danger delete-record">Delete</a></div></div><a href="javascript:;" class="btn btn-sm btn-text-secondary rounded-pill btn-icon item-edit"><i class="icon-base ri ri-edit-box-line icon-22px"></i></a>'
            }
        }],
        layout: {
            topStart: {
        ...
        drawCallback: function(e) {
            ...
            t.column(2, {
                ...
                var a, r;
                s !== e && ((a = document.createElement("tr")).classList.add("group"),
                (r = document.createElement("td")).setAttribute("colspan", "8"),
                r.textContent = e,
                a.appendChild(r),
    ...
    t && (i = new DataTable(t,{
        ...
        columnDefs: [{
            ...
            searchable: !1,
            render: function(e, t, a, r) {
                return '<div class="d-flex align-items-center"><div class="d-inline-block"><a href="javascript:;" class="btn btn-sm btn-text-secondary rounded-pill btn-icon dropdown-toggle hide-arrow" data-bs-toggle="dropdown"><i class="icon-base ri ri-more-2-line icon-22px"></i></a><div class="dropdown-menu dropdown-menu-end m-0"><a href="javascript:;" class="dropdown-item">Details</a><a href="javascript:;" class="dropdown-item">Archive</a><div class="dropdown-divider"></div><a href="javascript:;" class="dropdown-item text-danger delete-record">Delete</a></div></div><a href="javascript:;" class="btn btn-sm btn-text-secondary rounded-pill btn-icon item-edit"><i class="icon-base ri ri-edit-box-line icon-22px"></i></a></div>'
            }
        }],
        language: {
    ...
    document.addEventListener("click", function(e) {
        e.target.classList.contains("delete-record") && (i.row(e.target.closest("tr")).remove().draw(),
        e = document.querySelector(".dtr-bs-modal")) && e.classList.contains("show") && bootstrap.Modal.getInstance(e)?.hide()
    })),
    setTimeout( () => {
        [{
