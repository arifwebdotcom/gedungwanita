    ...
    return {
        init: function() {
            ...
            (i = new KTStepper(t)).on("kt.stepper.changed", (function(e) {
                5 === i.getCurrentStepIndex() ? (r.classList.remove("d-none"),
                r.classList.add("d-inline-block"),
                a.classList.add("d-none")) : 6 === i.getCurrentStepIndex() ? (r.classList.add("d-none"),
            ...
            r.addEventListener("click", (function(e) {
                n[3].validate().then((function(t) {
                    ...
                    setTimeout((function() {
                            e.preventDefault()
                            var form_data = $("#kt_modal_create_app_form").serializeArray();
