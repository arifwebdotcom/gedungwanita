                    ...
                    <div class="row">
                        <div class='<?= (user()->isadmin == 1?'col-md-2':'col-md-4'); ?>'>
                            <div class='form-group'>
                                ...
                                <input class='form-control' type='hidden' name='idmember' value='<?= $idmember ?>' id='idmember'>
                            </div>
                        </div>      
                        <div class='col-md-2'>
...
<script>
    ...
    function init() {
        ...
        var idmember = "";
        if ($("#idmember").val()) {
            idmember = "&idmember=" + $("#idmember").val();
        }
        ...
        var table = $('#invoice_table').DataTable({
            ...
            ajax: {
                type: "GET",
                url: '<?= route_to('laporan.datatablemember') ?>' + `?numrows=${numrows}${noinvoice}${asosiasi}${awal}${akhir}${status}${idmember}`,
                dataType: 'JSON',
                error: function(e) {
                    alert(e);
                },
