                ...
                <form id="periode_form" class="form" >
                    ...
                    <div class="d-flex flex-column mb-7 fv-row">
                        ...
                        <label class="d-flex align-items-center fs-6 fw-bold form-label mb-2">
                            ...
                            <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="Nama Periode"></i>
                        </label>
                        <!--end::Label-->
                    ...
                    <div class="d-flex flex-column mb-7 fv-row">
                        <label class="required fs-6 fw-bold mb-2">Periode</label>
                            ...
                            <div class="position-relative d-flex align-items-center">
                                ...
                                <!--end::Icon-->
                                <!--begin::Datepicker-->
                                <input class="form-control form-control-solid ps-12 periode" placeholder="Select a date" name="periode" id="periode" />
                                <!--end::Datepicker-->
                            </div>
                            <!--begin::Label-->
                    </div>         
