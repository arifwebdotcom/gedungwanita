...
<div class="card mb-5 mb-xl-8">
    ...
    <div class="card-header border-0 pt-5">
        ...
        <div class="card-toolbar">            
            <a href="!#" id='btn_create' class="btn btn-sm btn-light-primary" data-bs-toggle="modal" data-bs-target="#kelas_modal">
    ...
    <div class="card-body py-3">
        ...
        <div class="table-responsive">
            ...
            <div class="table-responsive text-nowrap">
                <table class="table" id="kelas_table"  style="width:100%">
                <thead>
                    <tr>
...
<div class="modal fade" id="kelas_modal" tabindex="-1" aria-modal="true" role="dialog">
...
<script>
    ...
    $('#btn_create').on('click', function() {
        $("#kelas_modal #modal_title").text("Tambah Kelas");
        $("#kelas_modal").modal("show");
    });

    $('#kelas_table tbody').on('click', '#edit', function() {
    ...
    $('#kelas_table tbody').on('click', '#delete', function() {
        var data = $('#kelas_table').DataTable().row($(this).parents('tr')).data();
        Swal.fire({
            title: "Apakah anda yakin?",
            text: "data "+data.kelas+" akan dihapus dari sistem",
            icon: "warning",
            ...
            if (result.value) {
                $.ajax({
                    url: `<?= base_url() ?>kelas/delete/${data.id}`,
                    type: 'post',
                    dataType: 'json',
                    data: "id="+data.id,
                    beforeSend: function() {
                ...
                toastr.error("data "+data.kelas+" tidak jadi dihapus");                
            }
        });
    ...
    $('#kelas_modal').on('hidden.bs.modal', function(e) {
        $(this).find("input,textarea").val('').end();
    }) 

    $('#kelas_form').on('submit', function(e) {
        e.preventDefault()
        var form_data = $(this).serializeArray();
        let id = $('#kelas_form #id').val();
        let route = (id != '') ?
            `<?= base_url() ?>kelas/${id}/edit` :
            "<?= route_to('kelas.store') ?>";
