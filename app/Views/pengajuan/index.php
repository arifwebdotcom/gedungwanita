...
<div class="card mb-5 mb-xl-8">
    ...
    <div class="card-header border-0 pt-5">
        ...
        <div class="card-toolbar">
            <a href="!#" id='btn_create' class="btn btn-sm btn-light-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_pengajuan">
...
<div class="modal fade" id="pengajuan_modal" tabindex="-1" aria-hidden="true">
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                <!--begin::Modal title-->
                <h2 id="modal_title">Tambah Pengajuan</h2>
                <!--end::Modal title-->
                <!--begin::Close-->
                ...
                <form id="pengajuan_form" class="form" >
                    ...
                    <div class="d-flex flex-column mb-7 fv-row">
                        ...
                        <label class="d-flex align-items-center fs-6 fw-bold form-label mb-2">
                            <span class="required">Pengajuan</span>
                            <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="Specify a card holder's name"></i>
                        </label>
                        <!--end::Label-->
                        <input type="text" class="form-control form-control-solid" placeholder="" id="pengajuan" name="pengajuan" />
                    </div>                    
                    <!--end::Input group-->
                    <!--begin::Actions-->
...
<script>
    ...
    const showPengajuan = () => {
        ...
        var table = $('#pengajuan_table').DataTable({
            ...
            lengthChange: false,
            ajax: {
                url: "<?= route_to('pengajuan.datatable') ?>",
            },
            columns: columns,
            "dom":
                "<'row'" +
    ...
    $('#pengajuan_table tbody').on('click', '#edit', function() {
        ...
        $("#pengajuan_modal #pengajuan").val(data.pengajuan);
        $("#pengajuan_modal #id").val(data.id);

        $("#pengajuan_modal #modal_title").text("Edit Pengajuan");
        $("#pengajuan_modal").modal("show");
    });
    ...
    $('#pengajuan_table tbody').on('click', '#delete', function() {
        ...
        Swal.fire({
            ...
            text: "data "+data.pengajuan+" akan dihapus dari sistem",
            icon: "warning",
            ...
            if (result.value) {
                $.ajax({
                    url: `<?= base_url() ?>pengajuan/delete/${data.id}`,
                    type: 'post',
                    dataType: 'json',
                    data: "id="+data.id,
                    beforeSend: function() {
