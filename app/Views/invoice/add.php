...
<div class="card mb-5 mb-xl-8">
    ...
    <div class="card-header border-0 pt-5">
        <h3 class="card-title align-items-start flex-column">
            <span class="card-label fw-bolder fs-3 mb-1">Tambah Invoice</span>
    ...
    <div class="card-body py-3 row">
        ...
        <div class="d-flex flex-column mb-7 fv-row col-lg-4">
            <label class="required fs-6 fw-bold mb-2">Tanggal Invoice</label>
                ...
                <div class="position-relative d-flex align-items-center">
                    ...
                    <!--end::Icon-->
                    <!--begin::Datepicker-->
                    <input class="form-control form-control-solid ps-12 periode" placeholder="Select a date" name="tglinvoice" id="tglinvoice" />
                    <!--end::Datepicker-->                    
                </div>
                <!--begin::Label-->
        ...
        <div class="fv-row mb-10 col-lg-4 notmodal">
            ...
            <select class="form-select form-select-solid" data-control="select2" data-hide-search="true" data-placeholder="Select Periode" name="untuk" id="untuk">        
                ...
                <option value="2">Asosiasi Tertentu</option>
                <option value="3">Anggota Tertentu</option>
            </select>
        </div>
        <!--end::Input group-->
        <!--begin::Input group-->
        ...
        <div class="d-flex flex-column mb-7 fv-row col-lg-4">
            <label class="required fs-6 fw-bold mb-2">Tanggal Jatuh Tempo</label>
                ...
                <div class="position-relative d-flex align-items-center">
                    ...
                    <!--end::Icon-->
                    <!--begin::Datepicker-->
                    <input class="form-control form-control-solid ps-12 periode" placeholder="Select a date" name="expired" id="expired" />
                    <!--end::Datepicker-->
                </div>
                <!--begin::Label-->
        </div>         
        <div class="d-flex flex-column mb-7 fv-row col-lg-4">
            <label class="required fs-6 fw-bold mb-2">Tanggal Dibayar</label>
                <!--begin::Input-->
                <div class="position-relative d-flex align-items-center">
                    <!--begin::Icon-->
                    <!--begin::Svg Icon | path: icons/duotune/general/gen014.svg-->
                    ...
                    <!--end::Icon-->
                    <!--begin::Datepicker-->
                    <input class="form-control form-control-solid ps-12 periode" placeholder="Select a date" name="tgldibayar" id="tgldibayar" />
                    <!--end::Datepicker-->
                </div>
                <!--begin::Label-->
        </div>         
